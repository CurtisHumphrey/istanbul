...
var handlebars = require('handlebars').create(),
    ...
    summaryTableHeader = [
        ...
        '   <th data-col="file_data" data-fmt="html" data-html="true" class="file">Last Modified</th>',
    ...
    summaryLineTemplate = handlebars.compile([
        ...
        '<td data-value="{{timestamp}}" class="file {{reportClasses.statements}}">{{localTimestamp}}</td>',
        ...
        children.forEach(function (child, index) {
            var metrics = child.metrics,
                ...
                data = {
                    ...
                    localTimestamp: (new Date(child.getTimestamp())).toLocaleString(),
